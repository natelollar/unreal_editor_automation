...
#test object
tst_obj = unreal.load_asset('/Game/Blueprints/warlock_all_lowA_warlock_belt_low_dup.warlock_all_lowA_warlock_belt_low_dup')
...
#....\Unreal Projects\Python\unreal_testA2.py
